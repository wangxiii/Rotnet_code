...
config = {}
# set the parameters related to the training and testing set(VGG face val set can't find nput randomly without process)
data_train_opt = {}
data_train_opt['batch_size'] = batch_size
data_train_opt['unsupervised'] = True
data_train_opt['epoch_size'] = None
data_train_opt['random_sized_crop'] = True
data_train_opt['dataset_name'] = 'face'
...
data_test_opt['dataset_name'] = 'face'
